...
public class TimeAdapter extends AbstractWheelTextAdapter {
     ...
     */
    public TimeAdapter(Context context, int minValue, int maxValue) {
     ...
     */
    public TimeAdapter(Context context, int minValue, int maxValue, final String format) {
    ...
    public TimeAdapter(Context context, int minValue, int maxValue, IntParamFunction<String> formatFunction) {
        super(context);
